...
* link:howto_create-external-plugin[External plugin creation]
* link:howto-devonfw-ide-CobiGen-PoC-E2E[End to End POC Code generation using Entity class]
* link:howto-devonfw-CobiGen-OpenAPI[End to End POC Code generation using OpenAPI]
* link:howto-devonfw-adapt_template[Adapt Template from CobiGen]
