...
Follow the setup instructions listed https://github.com/devonfw/devon-ide/blob/master/documentation/setup.adoc[here]. +
...
[NOTE]
====
We are using the `java` https://github.com/devonfw/devon-ide/blob/master/documentation/java.adoc[commandlet] of the devon IDE. After the command `create` we are passing the arguments `package`, `groupId` and `version` in this case.
====
[WARNING]
====
